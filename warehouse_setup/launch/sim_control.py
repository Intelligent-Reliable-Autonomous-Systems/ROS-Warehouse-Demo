...
def launch_setup(context, *args, **kwargs):
    ...
    '''robotiq_description_prefix = get_package_prefix("warehouse_world")
    ...
    pkg_warehouseworld_gz_sim = get_package_share_directory('warehouse_world')
    gz_robotiq_env_var_resource_path = AppendEnvironmentVariable(
        "GZ_SIM_RESOURCE_PATH", PathJoinSubstitution([pkg_warehouseworld_gz_sim, 'models'])
    )
